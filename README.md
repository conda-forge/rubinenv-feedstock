...
Once the `conda-forge/label/rubin-env_dev` channel has been enabled, `rubin-env, rubin-env-extras, rubin-env-nosysroot, rubin-env-rsp` can be installed with `conda`:
